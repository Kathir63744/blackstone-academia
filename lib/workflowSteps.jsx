// ============================================================
// FILE: lib/workflowSteps.jsx
// NEW FILE
// ============================================================

/* Extracted out of app/features/[slug]/page.jsx so the modules routes and the
   features routes share one copy instead of each keeping their own. */
...
export function getWorkflowSteps(slug) {
